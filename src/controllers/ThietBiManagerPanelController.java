 ...
 * @author Hai
 */
public class ThietBiManagerPanelController {
    
    private JPanel jpnView;
    private JTextField jtfSearch;
    private ThietBiService ThietBiService;
    private List<ThietBiBean> listThietBiBeans;
    private ClassTableModel classTableModel = null;
    private final String[] COLUMNS = {"Mã TB", "Tên TB", "Trạng thái", "Ngày thêm"};
    private JFrame parentJFrame;

    public ThietBiManagerPanelController(JPanel jpnView, JTextField jtfSearch) {
        this.jpnView = jpnView;
        this.jtfSearch = jtfSearch;
        classTableModel = new ClassTableModel();
        this.ThietBiService = new ThietBiService();
        this.listThietBiBeans = this.ThietBiService.getListThietBi();
        initAction();
    }

    public ThietBiManagerPanelController() {
    }
    ...
    public void initAction(){
        this.jtfSearch.getDocument().addDocumentListener(new DocumentListener() {
            ...
            public void insertUpdate(DocumentEvent e) {
                ...
                listThietBiBeans = ThietBiService.search(key.trim());
                setDataTable();
            }
    ...
    public void setDataTable() {
        ...
        this.listThietBiBeans.forEach(thiet_bi -> {
